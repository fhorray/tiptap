...
export const Editor = () => {
  ...
  // Função debounce definida fora do componente
  ...
  // Aqui, o uso de useCallback está correto, pois debounce é estável
  ...
  return (
    <main style={{ padding: "0 20px" }}>
      <div style={{ maxWidth: 1024, margin: "88px auto 120px" }}>
        <div
          style={{ display: "flex", gap: "12px", marginBottom: 10 }}
        ...
        <RcTiptapEditor
          ...
          output="json"
          content={""}
          onChangeContent={debounce((value: any) => {
            setContent(value);
          }, 300)}
